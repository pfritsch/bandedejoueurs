        ...
        if (!error && state === "signUp") {
          ...
          if (Meteor.isClient) {
            var emailData = {
              ...
              text: TAPi18n.__('emailWelcomeText', { urlGamesessions: FlowRouter.url('gamesessionList'), urlPlayers: FlowRouter.url('playerList'), urlProfile: FlowRouter.url('myProfile')}),
